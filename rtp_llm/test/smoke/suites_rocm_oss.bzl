    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                smoke_args="--quantization FP8_PER_CHANNEL_COMPRESSED --use_asm_pa 1 --act_type BF16 --seq_size_per_block 16 --reserver_runtime_mem_mb 51200 --tp_size 2 --world_size 2 --ep_size 1",
                gpu_type=["MI308X-ROCM7"],
            ),
        ],
    )
